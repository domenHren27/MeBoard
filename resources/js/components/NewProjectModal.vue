    ...
    <modal name="new-project" classes="p-10 bg-card rounded-lg" height="auto">
        ...
        <form @submit.prevent="submit">
            ...
            <footer class="flex justify-end">
                <button type="button" style="background-color: rgb(71, 205, 255);
                        text-decoration: none;
                        box-shadow: rgb(176, 234, 255) 0px 2px 7px 0px;
                        border-radius: 5rem;
                        color: white;
                        font-size: 0.8rem;" class="px-5 py-2 button is-outlined mr-4" @click="$modal.hide('new-project')">Cancel</button>
                <button class="button px-5 py-2" 
                style="background-color: rgb(71, 205, 255);
                        text-decoration: none;
                        box-shadow: rgb(176, 234, 255) 0px 2px 7px 0px;
                        border-radius: 5rem;
                        color: white;
